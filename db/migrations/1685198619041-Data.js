module.exports = class Data1685198619041 {
    name = 'Data1685198619041'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "auction" ("id" character varying NOT NULL, "status" text NOT NULL, "start_block" jsonb NOT NULL, "end_period_block" jsonb NOT NULL, "bidding_start_block" jsonb NOT NULL, "bidding_ends_block" jsonb NOT NULL, "onboard_start_block" jsonb NOT NULL, "onboard_end_block" jsonb NOT NULL, "timestamp" jsonb, CONSTRAINT "PK_9dc876c629273e71646cf6dfa67" PRIMARY KEY ("id"))`)
