module.exports = class Data1684777700720 {
    name = 'Data1684777700720'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "auction" ("id" character varying NOT NULL, "lease" integer NOT NULL, "ending_period" integer NOT NULL, CONSTRAINT "PK_9dc876c629273e71646cf6dfa67" PRIMARY KEY ("id"))`)
